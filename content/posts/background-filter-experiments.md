...
But this has the same issues as my initial attempt: the blur is being computed on the scale of the input image instead of the display
resolution, resulting in a distinctly unblurred image.
