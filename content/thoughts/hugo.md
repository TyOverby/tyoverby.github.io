...
In the hopes that I'll start regularly blogging soon, I decided to use a real static site generator
instead of the cobbled-together mess of `Makefile`s and `pandoc` that I used before.
